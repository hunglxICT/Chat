================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : ChatClient Project Overview
===============================================================================

The application wizard has created this ChatClient application for
...
ChatClientDlg.h, ChatClientDlg.cpp - the dialog
    ...
    in ChatClient.rc, which can be edited in Microsoft Visual C++.
